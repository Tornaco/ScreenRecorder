...
public class CountDownView extends FrameLayout {
    ...
    public static View make(Context context) {
        View container = LayoutInflater.from(context).inflate(R.layout.count_down_layout, null, false);
        CountDownView countDownView = (CountDownView) container.findViewById(R.id.count_down_view);
